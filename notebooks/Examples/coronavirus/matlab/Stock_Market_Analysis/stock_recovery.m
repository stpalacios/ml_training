...
figure(1)
plot(DJIA.Date,DJIA.Close,'r.-',...
    NASDAQ.Date,NASDAQ.Close,'g.-',...
    SnP500.Date,SnP500.Close,'b.-')
datetick('x', 'mm-dd-yy', 'keepticks')
legend('DJIA','NASDAQ','S\&P 500','Interpreter','latex')
xtickangle(45)
title('Recovery of stock prices after national event.','Interpreter','latex')
